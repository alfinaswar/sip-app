                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" name="NamaTtd" id="NamaTtd" class="form-control"
                                                        value="{{ old('NamaTtd', $suratIzin->NamaTtd) }}" placeholder="Nama yg bertanda tangan">
                                                </div>
                                                <div class="form-group mb-3">
                                                    <label for="Tmt">Pangkat NRP / NIP</label>
                                                    <input type="text" name="NamaTtd2" id="NamaTtd2" class="form-control"
                                                        value="{{ old('NamaTtd2', $suratIzin->NamaTtd2) }}" placeholder=" Kolonel Czi NRP 11000050710979">
                                                </div>
                                            </div>
                                        </div>
