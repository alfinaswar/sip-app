                            ...
                            <div class="card-body">
                                <form action="{{ route('surat-izin.update', $suratIzin->id) }}" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea name="NomorSIP" id="NomorSIP" class="form-control" placeholder="Masukkan Nomor SIP">{!! old('NomorSIP', $suratIzin->NomorSIP) !!}</textarea>
                                                <script>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="Korps" id="Korps" class="form-control">
                                                    <option value="{{ $suratIzin->Korps }}">{{ $suratIzin->Korps }}</option>
                                                    @php
                                                        $korpsList = [
                                                            'Inf',
                                                            'Arh',
                                                ...
                                                <div id="korpsLainnyaInput" class="mt-2"
                                                    style="display: {{ old('Korps', $suratIzin->Korps) == 'lainnya' ? 'block' : 'none' }};">
                                                    <input type="text" name="Korps_lainnya" class="form-control"
                                                        placeholder="Korps Lain nya"
                                                        value="{{ old('Korps_lainnya', old('Korps', $suratIzin->Korps) == 'lainnya' ? $suratIzin->Korps : '') }}">
                                                </div>
                                                <script>
                                                    document.addEventListener('DOMContentLoaded', function() {
                                                        const korpsSelect = document.getElementById('Korps');
                                                        const korpsLainnyaInput = document.getElementById('korpsLainnyaInput');
                                                        korpsSelect.addEventListener('change', function() {
                                                            if (korpsSelect.value === 'lainnya') {
                                                                korpsLainnyaInput.style.display = 'block';
                                                            } else {
                                                                korpsLainnyaInput.style.display = 'none';
                                                            }
                                                        });
                                                    });
                                                </script>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="Kpad" id="Kpad" class="form-control">
                                                    ...
                                                    <option value="Lainnya"
                                                        {{ old('Kpad', $suratIzin->Kpad) == 'Lainnya' ? 'selected' : '' }}>
                                                        Lainnya</option>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <select name="AnggotaKeluarga[{{ $i }}][hubungan]"
                                                                ...
                                                                <option value="">Pilih</option>
                                                                <option value="Suami"
                                                                    {{ ($anggota['hubungan'] ?? '') == 'Suami' ? 'selected' : '' }}>
                                                                    Suami</option>
                                                                <option value="Istri"
                                                                    {{ ($anggota['hubungan'] ?? '') == 'Istri' ? 'selected' : '' }}>
                                                                    Istri</option>
                                                                <option value="Anak"
                                                                    {{ ($anggota['hubungan'] ?? '') == 'Anak' ? 'selected' : '' }}>
                                                                    Anak</option>
                                                                <option value="Ayah"
                                                                    {{ ($anggota['hubungan'] ?? '') == 'Ayah' ? 'selected' : '' }}>
                                                                    Ayah</option>
                                                                <option value="Ibu"
                                                                    {{ ($anggota['hubungan'] ?? '') == 'Ibu' ? 'selected' : '' }}>
                                                                    Ibu</option>
                                                                <option value="Kakak"
                                                                    {{ ($anggota['hubungan'] ?? '') == 'Kakak' ? 'selected' : '' }}>
                                                                    Kakak</option>
                                                                <option value="Adik"
                                                                    {{ ($anggota['hubungan'] ?? '') == 'Adik' ? 'selected' : '' }}>
                                                                    Adik</option>
                                                                <option value="Mertua"
                                                                    {{ ($anggota['hubungan'] ?? '') == 'Mertua' ? 'selected' : '' }}>
                                                                    Mertua</option>
                                                                <option value="Menantu"
                                                                    {{ ($anggota['hubungan'] ?? '') == 'Menantu' ? 'selected' : '' }}>
                                                                    Menantu</option>
                                                                <option value="Cucu"
                                                                    {{ ($anggota['hubungan'] ?? '') == 'Cucu' ? 'selected' : '' }}>
                                                                    Cucu</option>
                                                                <option value="Keponakan"
                                                                    {{ ($anggota['hubungan'] ?? '') == 'Keponakan' ? 'selected' : '' }}>
                                                                    Keponakan</option>
                                                                <option value="Lainnya"
                                                                    {{ ($anggota['hubungan'] ?? '') == 'Lainnya' ? 'selected' : '' }}>
                                                                    Lainnya</option>
                                                            </select>
                                                        </td>
                                                        <td>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea name="Keterangan" id="Keterangan" class="form-control" rows="2" placeholder="Masukkan Keterangan">{{ old('Keterangan', $suratIzin->Keterangan) }}</textarea>
                                    </div>
